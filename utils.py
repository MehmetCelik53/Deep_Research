...
def get_today_str() -> str:
    ...
    now = datetime.now()
    # For windows compatibility, avoid using %-d or %#d
    # Use cross-platform formatting: inject the day integer to avoid platform-specific %-d or %#d

    return now.strftime("%a %b {day}, %Y").format(day=now.day)
